...
/**
 * speichert die Eigenschaften eines Hundes und stellt Hund-Funktionalit&auml;t zur Verf&uuml;gung
 */
public class Hund {

	private String name = "Bob"; // Der Hund hat einen Namen mit dem er gerufen wird
	private int groesse=60; // Die Grˆﬂe wird in cm eingetragen
	 ...
	 * 
	 * @param name 
	 * Name des Hunds besteht nur aus Buchstaben und am Anfang ein groﬂer Buchstabe
	 */
	...
	/**
	 * 
	 * @param groesse nur im Rahmen bereits bekannter Grˆﬂen von Hunden
	 */
	public void setGroesse(int groesse) {
		// Der kleinste Hund ist mindestens 10 cm groﬂ aber nie groesser als 111cm:
		if (groesse < 10) {
			System.out.println(
			...
			System.out.println(
					"So groﬂ ist kein Hund. Der grˆﬂte bekannte Hund war ein Great Dane Namens Zeus und war 1.118 m groﬂ.");
			this.groesse = 111;
		} else {
	...
	public void setGewicht(double gewicht) {
		...
		if (gewicht < 0.5) {
			this.gewicht = 0.5;
			System.out.println(
					"So wenig wiegt kein erwachsener Hund. Der leichteste Hund hieﬂ Miracle Milly und wo ca. 1 Pfund.");
		} else if (gewicht > 143) {
			this.gewicht = 143;
			System.out.println("So schwer ist kein Hund. Der schwerste bekannte Hund hieﬂ Zorbas und wog 143kg.");
		} else {
	...
	public void ausgabe() {
		...
		System.out.println("Er ist " + this.groesse + " cm groﬂ und wiegt " + this.gewicht + " kg.");
	}
